...
class AnalyseNum2 extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    // Rate Chart
    const roundsFrequen = calcNum2Frequen(rounds);
    ...
    return (
      <div className="container analyse-all">
        <h1 className="animated fadeIn">Phân tích vị trí số 2</h1>
...
AnalyseNum2.defaultProps = {
  rounds: null,
  numNumFrequens: null,
};

AnalyseNum2.propTypes = {
...
export default withTracker(() => {
  ...
  const numNumFrequens = calcGroupFrequen(calcNum2Frequen(rounds));
