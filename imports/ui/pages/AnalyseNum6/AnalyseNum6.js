...
class AnalyseNum6 extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    // Rate Chart
    const roundsFrequen = calcNum6Frequen(rounds);
    ...
    return (
      <div className="container analyse-all">
        <h1 className="animated fadeIn">Phân tích vị trí số 6</h1>
...
AnalyseNum6.defaultProps = {
  rounds: null,
  numNumFrequens: null,
};

AnalyseNum6.propTypes = {
