...
// Styles
import './Combine12Num.scss';

class Combine12Num extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
              ...
              <td key={num}>
                <span
                  ...
                  onClick={() => {
                    ...
                    if (newState && selectedNums.length < 12) {
    ...
    if (selectedNums.length >= 12) {
      ...
      const genRounds = Functions.generate(combs12, selectedNums);
    ...
    return (
      <div className="container analyse-all">
        <h1 className="animated fadeIn">Tổ hợp 12 số</h1>
        <h5 className="animated fadeIn mb-4">
          <i>* Có tất cả 924 bộ 6 số từ 12 số. Phát sinh 18 bộ số.</i>
        </h5>
        <div
...
Combine12Num.defaultProps = {
  rounds: null,
};

Combine12Num.propTypes = {
