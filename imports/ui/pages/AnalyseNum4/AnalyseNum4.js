...
class AnalyseNum4 extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    // Rate Chart
    const roundsFrequen = calcNum4Frequen(rounds);
    ...
    return (
      <div className="container analyse-all">
        <h1 className="animated fadeIn">Phân tích vị trí số 4</h1>
...
AnalyseNum4.defaultProps = {
  rounds: null,
  numNumFrequens: null,
};

AnalyseNum4.propTypes = {
