...
class AnalyseNum1 extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    // Rate Chart
    const roundsFrequen = calcNum1Frequen(rounds);
    ...
    return (
      <div className="container analyse-all">
        <h1 className="animated fadeIn">Phân tích vị trí số 1</h1>
...
AnalyseNum1.defaultProps = {
  rounds: null,
  numNumFrequens: null,
};

AnalyseNum1.propTypes = {
...
export default withTracker(() => {
  ...
  const numNumFrequens = calcGroupFrequen(calcNum1Frequen(rounds));
