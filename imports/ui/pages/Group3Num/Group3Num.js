...
class Group3Num extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className="container">
        <h1 className="animated fadeIn">Phân tích nhóm 3 số</h1>
            ...
            {numGroupShowFrequens.length <= 0 && (
              <div className="list-group">
                <div className="list-group-item text-center animated fadeIn">
                  {`Không có bộ 3 số nào chứa ${parseInt(
                    filterNum
...
export default withTracker(() => {
  ...
  const numGroupFrequens = calcCombineFrequen(rounds, 3);
