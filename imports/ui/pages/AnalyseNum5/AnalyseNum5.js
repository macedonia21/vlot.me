...
class AnalyseNum5 extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    // Rate Chart
    const roundsFrequen = calcNum5Frequen(rounds);
    ...
    return (
      <div className="container analyse-all">
        <h1 className="animated fadeIn">Phân tích vị trí số 5</h1>
...
AnalyseNum5.defaultProps = {
  rounds: null,
  numNumFrequens: null,
};

AnalyseNum5.propTypes = {
