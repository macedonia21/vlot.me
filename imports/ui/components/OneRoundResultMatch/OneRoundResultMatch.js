...
class OneRoundResultMatch extends React.Component {
  constructor(props) {
    super(props);
  }
    ...
    return (
      <div className="list-group-item fadeIn animated">
        ...
        <div className="list-group-item-text round-result result-num">
          <span
            className={
              roundData.result.num1Matched
                ? 'round-result-num matched'
                : 'round-result-num unmatched'
            }
          >
